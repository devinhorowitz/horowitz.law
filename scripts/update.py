...
SCREEN_SYSTEM = (
    ...
    "touches it. Your reason must name one of the categories above; if you cannot, PASS. Two that "
    "are read too broadly: 'landlord-tenant or dispossessory' means a fight over possession, "
    "eviction, or rent -- a personal-injury or premises claim is NOT one merely because a "
    "landlord, tenant, apartment complex, or condominium association is a party. And a bankruptcy "
    "posture is not on this list at all: a debtor's schedules or plan often appear in a case whose "
    "real subject is a personal-injury or insurance claim, and whether there is a tort or coverage "
    "nexus is for the later step that reads the whole opinion, not for you.\n\n"
