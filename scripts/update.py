...
SCREEN_SYSTEM = (
    ...
    "That list is CLOSED. Do not FAIL on any other ground, however plausible it sounds; if you "
    "cannot point to one of the categories above, PASS. In particular, a bankruptcy, receivership, "
    "or estate-administration caption is NOT a ground to FAIL -- the underlying dispute is often a "
    "personal-injury or insurance claim, and whether it has a tort or coverage nexus is decided by "
    "a later step that reads the whole opinion, not by you.\n\n"
