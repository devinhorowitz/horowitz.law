...
SCREEN_SYSTEM = (
    ...
    "civil-litigation and insurance audience focused on Georgia. The feed covers the Georgia and "
    "Florida appellate courts, the U.S. Court of Appeals for the Eleventh Circuit, and the U.S. "
    "Supreme Court. Florida is supplementary, so screen a Florida case on the same out-of-area "
    "grounds as any other, not for being from Florida. "
    ...
    "FAIL only if the case is clearly one of these: criminal (often captioned 'v. The State', 'v. State of Florida', or "
...
PRETRIAGE_SYSTEM = (
    ...
    "civil-litigation and insurance audience focused on Georgia. The feed covers the Georgia and "
    "Florida appellate courts, the U.S. Court of Appeals for the Eleventh Circuit, and the U.S. "
    "Supreme Court (Florida is supplementary, dropped only on the same out-of-area grounds). A first pass has "
...
TRIAGE_SYSTEM = (
    ...
    "civil-litigation and insurance audience focused on Georgia. The feed covers the Georgia and "
    "Florida appellate courts, the U.S. Court of Appeals for the Eleventh Circuit, and the U.S. "
    "Supreme Court. Florida is supplementary: keep a Florida decision when it decides a point in "
...
SYSTEM = (
    ...
    "civil-litigation and insurance audience focused on Georgia. The feed covers the Georgia and "
    "Florida appellate courts, the U.S. Court of Appeals for the Eleventh Circuit, and the U.S. "
    "Supreme Court. Florida is supplementary: a Florida decision in the areas below belongs on the "
    ...
    "Appeal, 'ca11' for the U.S. Court of Appeals for the Eleventh Circuit, 'scotus' for the "
    "U.S. Supreme Court.\n"
    "  - division: the Court of Appeals of Georgia division if the opinion states one (for "
    "example 'First Division'), otherwise null. Florida and federal opinions have no division.\n"
    ...
    "diversity. null for any state-court opinion (Georgia or Florida).\n"
