...
SYSTEM = (
    ...
    "  - tort_reform: a TRACKER tag for Georgia's tort-reform storyline. true when EITHER (1) a holding in the digest construes or applies one of the reform acts of "
    ...
    "amendment to O.C.G.A. section 51-12-33, including a holding the digest shows deciding whether or how one of those acts applies; OR (2) the digest states that the decision was superseded or abrogated by, or directly prompted, one of those acts. A passing mention is not enough, and a "
    "routine application of the PRE-reform version of a statute or framework that a reform act later displaced is not by itself the storyline.\n"
